...
const current = [
    {
        top: 'COVID-19 . Last night',
        main: 'PM Modi held a review meeting amid surge in COVID-19 cases across India',
        bottom: ''
    },
    {
        top: 'Politics Trending',
        main: '#POSTPONE_SSC_CHSL',
        bottom: 'Trending with Kejriwal, PM of India'
    },
    {
    ...
    {
        top: 'COVID-19 . LIVE',
        main: 'COVID-19 in India',
        bottom: ''
    },
    {
        top: 'The News Minute . Yesterday',
        main: 'Actor Vivek,  59, no more',
        bottom: ''
    }
]
...
const followItems = [
    {
        pic: 'https://pbs.twimg.com/profile_images/1308286636468219904/a61d79ts_x96.jpg',
        heading: 'Virat Kohli',
        id: '@imVkohli'
    },
    {
        pic: 'https://pbs.twimg.com/profile_images/1344225709770776576/_A_lMzCW_x96.png',
        heading: 'KUCOIN',
        id: '@kucoincom'
    }
]
...
const tweets = [
    {
        ...
        name: 'Jack Forge',
        id: '@TheJackForge . 15h',
        pic: "https://pbs.twimg.com/profile_images/1283187184028151809/L3SiFEL3_400x400.jpg",
        text: "My wife asked me why I'm so toxic sometimes. I looked her dead in the eye and said I'm a JavaScript developer.",
        reply: 35,
        share: 28,
        likes: 509,
    },
    {
        ...
        id: '@virendersehwag . 45m',
        pic: "https://pbs.twimg.com/profile_images/1025374083595350022/9nKlG5Nm_400x400.jpg",
        text: "Anyone looking for Plasma in Delhi,can connect on whatsapp helpline number- +91 8448884344",
        reply: 165,
        share: '5.3K',
        likes: '16.1K',
    },
    {
        ...
        id: '@tyler . 14h',
        pic: "https://pbs.twimg.com/profile_images/1362907617664913414/cPkexnme_x96.jpg",
        text: "#Bitcoin was always going to happen",
        reply: 99,
        share: 127,
        likes: '1.4K',
    },
    {
        ...
        name: 'Vlad Pasca',
        id: '@VladPasca5 . 22h',
        pic: "https://pbs.twimg.com/profile_images/1377357987359100936/uptxZfmS_x96.jpg",
        text: "JavaScript concepts you need to know before diving into React -Classes -Let and const -Arrow functions -Async and await -Template literals -Default parameters -Import/Export Module If you want to make the change easier, take the time to learn these!",
        reply: 15,
        share: 101,
        likes: 473,
    },
...
const CurrentEvent = (props) => {
    const { top, main, bottom } = props.item;
    return (
...
const FollowItem = (props) => {
    const { pic, heading, id } = props.item;
    return (
        <section className="follow-item">
            <img src={pic} alt=""></img>
            <div>
                <h3>{heading}</h3>
                <p>{id}</p>
...
const Tweets = (props) => {
    const { topic, name, id, pic, text, reply, share, likes } = props.item;
    return (
        <div className="tweet">
            <p>{topic}</p>
            <div className="tweet-head">
                <img src={pic} alt=""></img>
                <div className="tweet-head-info">
    ...
    return (
        < div className="left-container" >
            <div className="inner-left-container">
                <img src={TwitterLogoWhite} alt="" height="22px" className="twitter-logo"></img>
                <div className="left-link">
                    <svg viewBox="0 0 24 24" className="left-link-icon">
                        <g>
                            <path
                ...
                <button className="left-container-button">Tweet</button>
                <div className="profile">
                    <img src="https://abs.twimg.com/sticky/default_profile_images/default_profile_x96.png" alt="" />
                    <div>
                        <h3>Name Here</h3>
                        <h4>@username_123</h4>
                    </div>
                    <svg viewBox="0 0 24 24" style={{ width: "22px", fill: "white" }}>
                        <g>
        ...
        <React.Fragment>
            <div className="right-container">
                ...
                <div className="current-news">
                    ...
                    {current.map((item) => {
                        return (
                            <CurrentEvent item={item}></CurrentEvent>
                        );
                    })}
                ...
                <div className="whotofollow">
                    <h2>Who to Follow</h2>
                    <div className="follow-item-list">
                ...
                <div className="header-top">
                    ...
                    <div>
                        ...
                        <div className="link-icons">
                            ...
                            <button className="tweetBtn left-container-button">Tweet</button>
                        </div>
                    </div>
                </div>
